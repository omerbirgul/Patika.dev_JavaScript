let examGrade = prompt("Lütfen Notunuzu Girin:")
let TextInfo
...
if(examGrade >= 0 && examGrade <= 100){
    ...
    if(examGrade >= 90){
        ...
        TextInfo = "BB " + SMILE
        info.classList.add('nice')
        
    }
    else if(examGrade >= 75 ){
        TextInfo = " CB " + SMILE
        info.classList.add('well')
        
    }
    else if(examGrade >= 70 ){
        TextInfo = " CC " + SMILE
        info.classList.add('better')
    ...
    TextInfo = "Geçerli Not girin"
}


info.innerHTML=`Notunuz: ${examGrade}  ///  Harf Notunuz: ${TextInfo}`